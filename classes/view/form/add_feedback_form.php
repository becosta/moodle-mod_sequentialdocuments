...
class add_feedback_form extends moodleform {
    ...
    public function definition() {
        ...
        $form->addElement('editor', 'content', get_string('affcontent', 'mod_sequentialdocuments'));
        $form->setType('content', PARAM_RAW);
        $form->addRule('content', get_string('affrequired', 'mod_sequentialdocuments'), 'required', null, 'server');
